...
test:
	...
	@echo "Running tests for NVCF Service..."
	@cd services/nvcf && go test ./...
	@echo "Running tests for Order Events Analyzer Service..."
	@cd services/order-events-analyzer && go test ./...
...
fmt:
	...
	@cd services/nvcf && go fmt ./...
	@cd services/order-events-analyzer && go fmt ./...
...
lint: $(BIN_DIR)/golangci-lint
	...
	@cd services/nvcf && ../../$(BIN_DIR)/golangci-lint run ./... || true
	@cd services/order-events-analyzer && ../../$(BIN_DIR)/golangci-lint run ./... || true
