...
var Fleet = []CustomerConfig{
	{
		...
		Profile: CustomerProfile{QPSScale: 1.2, WriteFraction: 0.18, BufferHitFloor: 0.99, StorageTier: "io2-50k"},
	},
	{
		ID: "c-kotak-bank", Name: "Kotak Mahindra Bank", Tier: "enterprise", DBs: 38,
		Profile: CustomerProfile{QPSScale: 1.4, WriteFraction: 0.22, BufferHitFloor: 0.99, StorageTier: "io2-50k"},
	},
	{
		ID: "c-tata-motors", Name: "Tata Motors", Tier: "enterprise", DBs: 14,
		Profile: CustomerProfile{QPSScale: 0.8, WriteFraction: 0.45, BufferHitFloor: 0.94, StorageTier: "io2-25k"},
	},
	{
		ID: "c-reliance-jio", Name: "Reliance Jio", Tier: "enterprise", DBs: 26,
		Profile: CustomerProfile{QPSScale: 2.0, WriteFraction: 0.32, BufferHitFloor: 0.97, StorageTier: "io2-25k"},
	},
	{
		ID: "c-iocl", Name: "Indian Oil Corporation", Tier: "enterprise", DBs: 18,
		Profile: CustomerProfile{QPSScale: 0.6, WriteFraction: 0.28, BufferHitFloor: 0.96, StorageTier: "gp3"},
	},
	{
		ID: "c-infosys", Name: "Infosys", Tier: "business", DBs: 12,
		Profile: CustomerProfile{QPSScale: 0.4, WriteFraction: 0.35, BufferHitFloor: 0.92, StorageTier: "gp3"},
	},
}
